...
left `NA`) – see `data-raw/add_kachergis2012_highlighting.R` for
details, and `tests/bakeoff_comparison/kachergis2012_highlighting_fit.R`
for a custom scoring function that fits all of the paper's reported
response proportions (including the "I" item's early/late split)
directly.
