# data merging for asymmetric conditions
require(here)
require(tidyverse)

load(here("data-raw/data/asym_test_data.RData")) # tdat

tdat |> rename(word = word,
               object = Response) |>
  group_by(condnum)

load("data-raw/data/asymmetric_conditions.RData")
