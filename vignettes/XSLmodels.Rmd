...
```{r}
## TESTING
pv <- xsl_run(propose_but_verify(alpha = .1, alpha_increase = .5), data = xsl_datasets[1:3])
...
# TODO: these currently take too long for vignette, change to faster model
...
stochastic_model_names <- c("guess-and-test", "pursuit",
                            "trueswell2012", "kachergis_sampling")
```
